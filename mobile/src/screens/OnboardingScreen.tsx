...
const PAGES = [
  {
    ...
    subtitle: 'Find jeepney routes, check schedules and download maps for offline use.',
  ...
  },
  {
    ...
    subtitle: 'Our AI finds the best jeepney route for you based on where you are right now.',
    image:    require('../../assets/giphy1.gif'),
    button:   'Next',
  },
  {
          ...
          <View style={styles.dots}>
            {PAGES.map((p) => (
              <View
                ...
                style={[
                  styles.dot,
                  p.id - 1 === currentIndex ? styles.dotActive : styles.dotInactive,
                ]}
              />
            ))}
          </View>
